...
class KBListener(Listener):
    ...
    def __parse_rule(self, ctx: Parser.RuleContext) -> None:
        elements2 = [name for name, value in self.implication.items()]
